...
<body>
	<form name="myform">
		<table border="0">
			<tr><td valign="top">
				<audio id="media" controls ONDRAGSTART="window.event.returnValue=false" onSelectStart="event.returnValue=false"
ONCONTEXTMENU="window.event.returnValue=false;alert('如有需求請聯絡:')"> //FF not supported mp3
					audio not supported
				</audio><br>
				播放速度:
