...
var WaveSurfer = {
    ...
    init: function (params) {
		...
		this.defaultParams.minPxPerSec *= zoom;
	...
	playByText: function (TextTime) {
        this.seekTo(TextTime/this.backend.getDuration());
	...
	zoomin: function () {
		if(wavesurfer.params.minPxPerSec<=max)
		{
			wavesurfer.params.minPxPerSec *= ratio;
			wavesurfer.bindMarks();
			wavesurfer.bindDragNDrop();			
			wavesurfer.load( file_name + ".wav");
		}
    },
	
	zoomout: function () {
		if(wavesurfer.params.minPxPerSec>=min)
		{
			wavesurfer.params.minPxPerSec /= ratio;
			wavesurfer.bindMarks();
			wavesurfer.bindDragNDrop();				
