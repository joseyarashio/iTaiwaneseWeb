...
<table border="1" width="50%" align="left">
	...
	<tr>
		<td>學生性別</td>
		<td><input type="radio" name="student_sex" value="男">男<input type="radio" name="student_sex" value="女">女</td>
	</tr>
	<tr>
		<td>學生生日</td>
	...
	<tr>
		<td>家長性別</td>
		<td><input type="radio" name="parent_sex" value="男">男<input type="radio" name="parent_sex" value="女">女</td>
	</tr>
	<tr>
		<td>家裡電話</td>
